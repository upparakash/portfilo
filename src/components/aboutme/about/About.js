          ...
          <Col md={7}>
            <Fade duration={3000}>
              <p className="home-about-body">
                My name is <b className="purple">Uppar Akash </b> 
                  and I am a <b className="purple">Computer Science and Engineering </b> 
                    student at <b className="purple">St. Mary’s Engineering College </b>
                      in Deshmukhi, Hyderabad.
                <br />
                <br />
                        I am proficient in various programming languages such as &nbsp;
                  <b className="purple">
                    {" "}
                     Java,  HTML, CSS, ReactJS,ReatVite,ReactNative,Postman,Mysql,VScode,Android Studio,Ecllipse and JavaScript.{" "}
                  </b>
                <br />
                <br />
